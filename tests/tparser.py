...
parser = argparse.ArgumentParser(description="Config values for Frozen Lake tests")
parser.add_argument(
    "-chdir",
    "--checkpoint_dir",
    default="tests/outcomes/checkpoints/",
    type=str,
...
parser.add_argument(
    "-resdir",
    "--results_dir",
    default="tests/outcomes/results/",
    type=str,
...
parser.add_argument(
    "-niter", "--num_iter", default=100, type=int, help="Number of iterations to run"
)
parser.add_argument(
